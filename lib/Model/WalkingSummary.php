...
class WalkingSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'walking_summary';
     ...
     * Sets id
     *
     * @param int $id The walking summary id
     *
     * @return $this
     */
     ...
     * Sets animal_id
     *
     * @param int $animal_id The id of the animal this walking summary belongs to
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date The datetime of the walking summary
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total The total walking time (minutes)
     *
     * @return $this
     */
     ...
     * Sets quarters
     *
     * @param int $quarters The number of quarters this walking summary is based on
     *
     * @return $this
     */
     ...
     * Sets average
     *
     * @param int $average The average walking time of this animal (minutes)
     *
     * @return $this
     */
     ...
     * Sets attention
     *
     * @param bool $attention Indicates an walking time attention
     *
     * @return $this
     */
