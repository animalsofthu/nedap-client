 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WeightVisit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'weight_visit';
     ...
     * Sets start_time
     *
     * @param \DateTime $start_time The start time of the weight visit in ISO8601 format
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param \DateTime $end_time The end time of the weight visit in ISO8601 format
     *
     * @return $this
     */
