...
/**
 * AnimalWeekSummary Class Doc Comment
 *
 * @category Class
 * @description This method lists the animal week weights.  If the end datetime is not specified the current datetime will be used. If the start datetime is not specified the start datetime will be the end datetime - 7 days.  Note:   1. The maximum period to request data is 1 year per API call.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnimalWeekSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'animal_week_summary';
     ...
     * Sets start_of_week
     *
     * @param \DateTime $start_of_week Start of the week in the installation timezone
     *
     * @return $this
     */
