...
class LyingSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'lying_summary';
     ...
     * Sets id
     *
     * @param int $id The lying summary id
     *
     * @return $this
     */
     ...
     * Sets animal_id
     *
     * @param int $animal_id The id of the animal this lying summary belongs to
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date The datetime of the lying summary
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total The total lying time (minutes)
     *
     * @return $this
     */
     ...
     * Sets quarters
     *
     * @param int $quarters The number of quarters this lying summary is based on
     *
     * @return $this
     */
     ...
     * Sets average
     *
     * @param int $average The average lying time of this animal (minutes)
     *
     * @return $this
     */
     ...
     * Sets attention
     *
     * @param bool $attention Indicates an lying time attention
     *
     * @return $this
     */
