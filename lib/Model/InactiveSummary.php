...
class InactiveSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inactive_summary';
     ...
     * Sets id
     *
     * @param int $id The inactive summary id
     *
     * @return $this
     */
     ...
     * Sets animal_id
     *
     * @param int $animal_id The id of the animal this inactive summary belongs to
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date The datetime of the inactive summary
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total The total inactive time (seconds)
     *
     * @return $this
     */
     ...
     * Sets average
     *
     * @param int $average The average inactive time of this animal
     *
     * @return $this
     */
     ...
     * Sets attention
     *
     * @param bool $attention Indicates an inactive time attention
     *
     * @return $this
     */
