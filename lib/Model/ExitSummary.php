 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExitSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'exit_summary';
    ...
    protected static $setters = [
        'exit_direction' => 'setExitDirection',
    ...
    protected static $getters = [
        'exit_direction' => 'getExitDirection',
    ...
    {
        $this->container['exit_direction'] = isset($data['exit_direction']) ? $data['exit_direction'] : null;
     ...
     * @return string
     */
    public function getExitDirection()
    {
        return $this->container['exit_direction'];
    }

    /**
     * Sets exit_direction
     *
     * @param string $exit_direction The sorter exit direction [LEFT, MIDDLE, RIGHT]
     *
     * @return $this
     */
    public function setExitDirection($exit_direction)
    {
        $this->container['exit_direction'] = $exit_direction;
     ...
     * Sets average_weight
     *
     * @param int $average_weight The average weight
     *
     * @return $this
     */
