...
class StepsSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'steps_summary';
     ...
     * Sets id
     *
     * @param int $id The step summary id
     *
     * @return $this
     */
     ...
     * Sets animal_id
     *
     * @param int $animal_id The id of the animal this step summary belongs to
     *
     * @return $this
     */
     ...
     * Sets average
     *
     * @param int $average The average number of steps of this animal
     *
     * @return $this
     */
     ...
     * Sets label_type
     *
     * @param int $label_type The label type; 1: Intime Leg, 2: Realtime Leg
     *
     * @return $this
     */
     ...
     * Sets attention
     *
     * @param bool $attention Whether the summary contains a decreased activity attention
     *
     * @return $this
     */
