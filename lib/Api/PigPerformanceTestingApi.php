...
/**
 * PigPerformanceTestingApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PigPerformanceTestingApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation animalVisitsByAnimal
     *
     ...
     * @return \Swagger\Client\Model\AnimalVisit
     */
    public function animalVisitsByAnimal($animal_uuid, $start_date = null, $end_date = null)
    {
        list($response) = $this->animalVisitsByAnimalWithHttpInfo($animal_uuid, $start_date, $end_date);
        return $response;
    }

    /**
     * Operation animalVisitsByAnimalWithHttpInfo
     *
     * animal visits for an animal
     *
     * @param  string $animal_uuid Animal UUID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AnimalVisit, HTTP status code, HTTP response headers (array of strings)
     */
    public function animalVisitsByAnimalWithHttpInfo($animal_uuid, $start_date = null, $end_date = null)
    {
        $returnType = '\Swagger\Client\Model\AnimalVisit';
        $request = $this->animalVisitsByAnimalRequest($animal_uuid, $start_date, $end_date);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AnimalVisit',
    ...
    /**
     * Operation animalVisitsByAnimalAsync
     *
     * animal visits for an animal
     *
     * @param  string $animal_uuid Animal UUID (required)
     ...
     */
    public function animalVisitsByAnimalAsync($animal_uuid, $start_date = null, $end_date = null)
    {
        return $this->animalVisitsByAnimalAsyncWithHttpInfo($animal_uuid, $start_date, $end_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation animalVisitsByAnimalAsyncWithHttpInfo
     *
     * animal visits for an animal
     *
     * @param  string $animal_uuid Animal UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function animalVisitsByAnimalAsyncWithHttpInfo($animal_uuid, $start_date = null, $end_date = null)
    {
        $returnType = '\Swagger\Client\Model\AnimalVisit';
        $request = $this->animalVisitsByAnimalRequest($animal_uuid, $start_date, $end_date);
    ...
    /**
     * Create request for operation 'animalVisitsByAnimal'
     *
     * @param  string $animal_uuid Animal UUID (required)
     * @param  \DateTime $start_date start datetime (inclusive). Example: 2020-07-15T08:07:19Z (optional)
     * @param  \DateTime $end_date end datetime (exclusive). Example: 2020-07-15T08:07:19Z (optional)
     ...
     */
    protected function animalVisitsByAnimalRequest($animal_uuid, $start_date = null, $end_date = null)
    {
        // verify the required parameter 'animal_uuid' is set
        if ($animal_uuid === null || (is_array($animal_uuid) && count($animal_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $animal_uuid when calling animalVisitsByAnimal'
            );
        }

        $resourcePath = '/v1/pig_performance_testing/animal/animal_visits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation animalVisitsByLocation
     *
     ...
     * @return \Swagger\Client\Model\AnimalVisit
     */
    public function animalVisitsByLocation($location_uuid, $start_date = null, $end_date = null)
    {
        list($response) = $this->animalVisitsByLocationWithHttpInfo($location_uuid, $start_date, $end_date);
        return $response;
    }

    /**
     * Operation animalVisitsByLocationWithHttpInfo
     *
     * animal visits for a location
     *
     * @param  string $location_uuid Location UUID (required)
     ...
     * @return array of \Swagger\Client\Model\AnimalVisit, HTTP status code, HTTP response headers (array of strings)
     */
    public function animalVisitsByLocationWithHttpInfo($location_uuid, $start_date = null, $end_date = null)
    {
        $returnType = '\Swagger\Client\Model\AnimalVisit';
        $request = $this->animalVisitsByLocationRequest($location_uuid, $start_date, $end_date);
    ...
    /**
     * Operation animalVisitsByLocationAsync
     *
     * animal visits for a location
     *
     * @param  string $location_uuid Location UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function animalVisitsByLocationAsync($location_uuid, $start_date = null, $end_date = null)
    {
        return $this->animalVisitsByLocationAsyncWithHttpInfo($location_uuid, $start_date, $end_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation animalVisitsByLocationAsyncWithHttpInfo
     *
     * animal visits for a location
     *
     * @param  string $location_uuid Location UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function animalVisitsByLocationAsyncWithHttpInfo($location_uuid, $start_date = null, $end_date = null)
    {
        $returnType = '\Swagger\Client\Model\AnimalVisit';
        $request = $this->animalVisitsByLocationRequest($location_uuid, $start_date, $end_date);
    ...
    /**
     * Create request for operation 'animalVisitsByLocation'
     *
     * @param  string $location_uuid Location UUID (required)
     * @param  \DateTime $start_date start datetime (inclusive). Example: 2020-07-15T08:07:19Z (optional)
     * @param  \DateTime $end_date end datetime (exclusive). Example: 2020-07-15T08:07:19Z (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function animalVisitsByLocationRequest($location_uuid, $start_date = null, $end_date = null)
    {
        // verify the required parameter 'location_uuid' is set
        if ($location_uuid === null || (is_array($location_uuid) && count($location_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location_uuid when calling animalVisitsByLocation'
            );
        }

        $resourcePath = '/v1/pig_performance_testing/location/animal_visits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
