...
/**
 * HeatDetectionAdvancedApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HeatDetectionAdvancedApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation activityDaySummaries
     *
     * Get activity day summaries of an animal
     *
     * @param  int $animal_id The ID of the animal (required)
     * @param  \DateTime $start_date start datetime (inclusive). Example: 2020-07-13T22:00:00Z (optional)
     * @param  \DateTime $end_date end datetime (exclusive). Example: 2020-07-14T22:00:00Z (optional)
     * @param  int $label_type The label type; 0: Unknown, 1: Intime, 2: Realtime Leg, 3: Realtime Neck (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\HeatDetectionSummary
     */
    public function activityDaySummaries($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        list($response) = $this->activityDaySummariesWithHttpInfo($animal_id, $start_date, $end_date, $label_type);
        return $response;
    }

    /**
     * Operation activityDaySummariesWithHttpInfo
     *
     * Get activity day summaries of an animal
     *
     * @param  int $animal_id The ID of the animal (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\HeatDetectionSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function activityDaySummariesWithHttpInfo($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        $returnType = '\Swagger\Client\Model\HeatDetectionSummary';
        $request = $this->activityDaySummariesRequest($animal_id, $start_date, $end_date, $label_type);
    ...
    /**
     * Operation activityDaySummariesAsync
     *
     * Get activity day summaries of an animal
     *
     * @param  int $animal_id The ID of the animal (required)
     ...
     */
    public function activityDaySummariesAsync($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        return $this->activityDaySummariesAsyncWithHttpInfo($animal_id, $start_date, $end_date, $label_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activityDaySummariesAsyncWithHttpInfo
     *
     * Get activity day summaries of an animal
     *
     * @param  int $animal_id The ID of the animal (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activityDaySummariesAsyncWithHttpInfo($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        $returnType = '\Swagger\Client\Model\HeatDetectionSummary';
        $request = $this->activityDaySummariesRequest($animal_id, $start_date, $end_date, $label_type);
    ...
    /**
     * Create request for operation 'activityDaySummaries'
     *
     * @param  int $animal_id The ID of the animal (required)
     * @param  \DateTime $start_date start datetime (inclusive). Example: 2020-07-13T22:00:00Z (optional)
     * @param  \DateTime $end_date end datetime (exclusive). Example: 2020-07-14T22:00:00Z (optional)
     ...
     */
    protected function activityDaySummariesRequest($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        // verify the required parameter 'animal_id' is set
        if ($animal_id === null || (is_array($animal_id) && count($animal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $animal_id when calling activityDaySummaries'
            );
        }
        if ($label_type !== null && $label_type > 3) {
            throw new \InvalidArgumentException('invalid value for "$label_type" when calling HeatDetectionAdvancedApi.activityDaySummaries, must be smaller than or equal to 3.');
        }
        if ($label_type !== null && $label_type < 0) {
            throw new \InvalidArgumentException('invalid value for "$label_type" when calling HeatDetectionAdvancedApi.activityDaySummaries, must be bigger than or equal to 0.');
        }


        $resourcePath = '/v1/heat_detection/activity/animal/day_summaries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($label_type !== null) {
            $queryParams['label_type'] = ObjectSerializer::toQueryValue($label_type);
        }
    ...
    /**
     * Operation activityTwoHourData
     *
     * Get two hour activities of an animal
     *
     * @param  int $animal_id The id of the animal this activity belongs to (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ActivityData
     */
    public function activityTwoHourData($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        list($response) = $this->activityTwoHourDataWithHttpInfo($animal_id, $start_date, $end_date, $label_type);
        return $response;
    }

    /**
     * Operation activityTwoHourDataWithHttpInfo
     *
     * Get two hour activities of an animal
     *
     * @param  int $animal_id The id of the animal this activity belongs to (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ActivityData, HTTP status code, HTTP response headers (array of strings)
     */
    public function activityTwoHourDataWithHttpInfo($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        $returnType = '\Swagger\Client\Model\ActivityData';
        $request = $this->activityTwoHourDataRequest($animal_id, $start_date, $end_date, $label_type);
    ...
    /**
     * Operation activityTwoHourDataAsync
     *
     * Get two hour activities of an animal
     *
     * @param  int $animal_id The id of the animal this activity belongs to (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activityTwoHourDataAsync($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        return $this->activityTwoHourDataAsyncWithHttpInfo($animal_id, $start_date, $end_date, $label_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activityTwoHourDataAsyncWithHttpInfo
     *
     * Get two hour activities of an animal
     *
     * @param  int $animal_id The id of the animal this activity belongs to (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activityTwoHourDataAsyncWithHttpInfo($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        $returnType = '\Swagger\Client\Model\ActivityData';
        $request = $this->activityTwoHourDataRequest($animal_id, $start_date, $end_date, $label_type);
    ...
    /**
     * Create request for operation 'activityTwoHourData'
     *
     * @param  int $animal_id The id of the animal this activity belongs to (required)
     * @param  \DateTime $start_date start datetime (inclusive). Example: 2020-07-15T08:07:19Z (optional)
     * @param  \DateTime $end_date end datetime (exclusive). Example: 2020-07-15T08:07:19Z (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function activityTwoHourDataRequest($animal_id, $start_date = null, $end_date = null, $label_type = null)
    {
        // verify the required parameter 'animal_id' is set
        if ($animal_id === null || (is_array($animal_id) && count($animal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $animal_id when calling activityTwoHourData'
            );
        }
        if ($label_type !== null && $label_type > 3) {
            throw new \InvalidArgumentException('invalid value for "$label_type" when calling HeatDetectionAdvancedApi.activityTwoHourData, must be smaller than or equal to 3.');
        }
        if ($label_type !== null && $label_type < 0) {
            throw new \InvalidArgumentException('invalid value for "$label_type" when calling HeatDetectionAdvancedApi.activityTwoHourData, must be bigger than or equal to 0.');
        }


        $resourcePath = '/v1/heat_detection/activity/animal/two_hour_data';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
