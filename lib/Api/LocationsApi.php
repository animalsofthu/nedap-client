...
class LocationsApi
{
    ...
    {
        list($response) = $this->locationByIdWithHttpInfo($id);
        return $response;
    }
    ...
    {
        list($response) = $this->locationByUuidWithHttpInfo($uuid);
        return $response;
    }
     ...
     * @param  int $animal_id The id of the animal that should belong to the location (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Location
    ...
    {
        list($response) = $this->locationsWithHttpInfo($type, $number, $animal_id);
        return $response;
    }
